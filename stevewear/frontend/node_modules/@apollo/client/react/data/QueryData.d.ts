import { QueryResult, QueryDataOptions, QueryTuple } from '@apollo/src/react/types/types';
import { OperationData } from '@apollo/src/react/data/OperationData';
export declare class QueryData<TData, TVariables> extends OperationData<QueryDataOptions<TData, TVariables>> {
    ...
    cleanup(): void;
    getOptions(): import("@apollo/src/react/types/types").CommonOptions<QueryDataOptions<TData, TVariables>>;
    ssrInitiated(): any;

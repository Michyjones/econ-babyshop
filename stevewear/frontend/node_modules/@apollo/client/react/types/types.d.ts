...
export interface BaseMutationOptions<TData, TVariables extends OperationVariables, TContext extends DefaultContext = DefaultContext, TCache extends ApolloCache<any> = ApolloCache<any>> extends Omit<MutationOptions<TData, TVariables, TContext, TCache>, "mutation"> {
    client?: ApolloClient<object>;
...
export interface MutationFunctionOptions<TData, TVariables, TContext, TCache extends ApolloCache<any>> extends BaseMutationOptions<TData, TVariables, TContext, TCache> {
...
export interface MutationDataOptions<TData, TVariables extends OperationVariables, TContext extends DefaultContext, TCache extends ApolloCache<any>> extends BaseMutationOptions<TData, TVariables, TContext, TCache> {
    mutation: DocumentNode | TypedDocumentNode<TData, TVariables>;
}
export declare type MutationTuple<TData, TVariables, TContext, TCache extends ApolloCache<any>> = [
